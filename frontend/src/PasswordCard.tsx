...
export function PasswordCardComponent(props: {
   passwordCard: PasswordCard;
   setEdit: (card: PasswordCard) => void;
}) {
   ...
   return (
      <Card className="card">
         ...
         <div>
            ...
            <Button onClick={togglePassword}>{passwordInfo.showPassword ? 'Hide' : 'Show'}</Button>
            <Button onClick={copyToClipboard}>Copy</Button>
         </div>
         <p>URL: {props.passwordCard.url}</p>
         <Button onClick={() => deleteCard(props.passwordCard.id)}>Delete</Button>
         <Button onClick={() => props.setEdit(props.passwordCard)}>Edit</Button>
      </Card>
   );
}
